...
# Used to read Text Content from PDF
def pdf_reader(file):
...
# Function used to display Resume
...
# Recommend Courses from The List of Courses
    ...
    if choice == 'Normal User':
        ...
        if st.button('Login'):
            if ad_user == 'root' and ad_password == 'root':
                ...
                print(plot_data.Predicted_Field)
                ...
                # # fig = px.pie(df, values=values, title='Predicted Field according to the Skills')
                # fig = px.pie(df, names='Predicted Field', values=labels, title='Predicted Field according to the Skills')
                # fig.show()
